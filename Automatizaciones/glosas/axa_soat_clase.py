...
from Automatizaciones.glosas import axa_soat


class EstrategiaAxaSoatGlosas(EstrategiaAseguradora):
    """
    Estrategia para automatización de AXA SOAT en modo GLOSAS.
    ...
    def procesar_factura(self, page: Page, contexto: Optional[FrameLocator], 
        ...
        try:
            estado, radicado, factura, logs = axa_soat.procesar_carpeta(
                page, subfolder_path, subfolder_name, context
            )
            ...
            return False, f"Error procesando AXA SOAT: {e}"
